...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tesseract_activity_main);
        mSvCamera = findViewById(R.id.surface_view);
...
//                }, 700);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.ivCapturePhoto) {// 拍照,设置相关参数
            try {
    ...
    Camera.PictureCallback jpgPictureCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            try {
                ...
                FileUtils.saveToSDCard(sizeBitmap);
                bitmap.recycle();
                bitmap = sizeBitmap;
                ...
                FileUtils.saveToSDCard(normalBitmap);
                bitmap.recycle();
                bitmap = normalBitmap;
